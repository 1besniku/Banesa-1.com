...
@section('content')
    <div class="bg-gray-100 mx-auto max-w-6xl bg-white py-20 px-12 lg:px-24 shadow-xl mt-6 mb-24"
        ...
        <h3 class="text-center text-black font-bold ">Kush jemi ne!</h3>
        <p class="mt-6">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin
        ...
        <div class="-mx-3 md:flex mt-2 mt-6">
